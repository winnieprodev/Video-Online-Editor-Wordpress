...
?>
    ...
    <!-- subtitle -->
    <!-- <link href="<?php echo $video_edit_url; ?>/assets/subtitle/amalia.js.min.css" rel="stylesheet" type="text/css" /> -->
    <!-- end subtitle -->
				...
				<div class="col-md-12" style="padding: 0px;">
					<div class="tabbable-line col-md-5" style="min-height: 400px; border:1px solid #ddd; padding: 0px;">
			            <ul class="nav nav-tabs" style="background-color: #ddd; border-top: 5px solid #ddd;">
			                <li class="active video_upload_tab">
			                    <a href="#" style="font-size: 16px; font-weight: bold;"> Video </a>
			                </li>
			                <li class="text_edit_tab">
			                    <a href="#" style="font-size: 16px; font-weight: bold;"> Text </a>
			                </li>
			                <li class="image_upload_tab">
			                    <a href="#" style="font-size: 16px; font-weight: bold;"> Gifs & Images </a>
			                </li>
			            ...
			            <div class="tab-content col-md-12" style="padding-top: 0px; padding-bottom: 0px;">
			                <!-- Video Uploads -->
			                <div class="tab-pane active" id="video_upload_tab">
			                ...
			                <div class="tab-pane" id="text_edit_tab">
						        <div class="col-md-12" style="padding-top: 10px;">
			                		...
			                		<div class="col-md-12 text_range form-horizontal" style="padding-bottom: 20px; padding-top: 0px; height: 391px;">
			                		...
			                		<div class="col-md-12" style="border-top: 1px solid #ddd; padding-top: 10px; padding-bottom: 10px;">
			                		...
			                		<div class="col-md-12 subtitle_upload_range" style="padding-bottom: 20px; padding-top: 10px;">
						            	...
						            	<div class="col-md-12 subtitle_edit_div" style="padding: 0px;">
						            		...
						            		<div id="subtitle_content_form" class="col-md-12" style="max-height: 260px; overflow-y: scroll; margin-top: 10px; padding-left: 0px;">
						            			<!-- <textarea id="subtitle_content" rows="6" style="height: 220px; padding: 10px;"></textarea> -->

						            			<!-- <div id="subtitle_0">
						            				<p class="col-md-3" id="subtitle_time_0"></p>
						            				<p class="col-md-9 subtitle_content" id="subtitle_content_0" contenteditable="false"></p>
						            			</div> -->
			        ...
			        <div class="col-md-7 text-center" style="padding: 0px; background-color: #ccc;">
			        	<div class="col-md-12" style="height: 53px; background-color: #ddd; ">
			        		<h1 style="font-size: 18px;"> <i class="icon icon-clock"></i> &nbsp;&nbsp; <span class="duration">00:00:00</span> </h1>
			        	</div>
			        	<div id="working_panel_top" style="height: 360px; margin-top: 50px; margin-bottom: 42px; display: inline-block; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
			        		<div id="working_panel" class="col-md-12 working_panel resize-container" style="padding: 0px; width: 640px; height: 360px;">
			        			<img id="working_panel_template" class="working_panel_template" style="width: 640px; height: 360px; box-sizing: border-box;" src="<?php echo $video_edit_url; ?>/images/default.png"/>
    ...
    <!-- subtitle -->
    <!-- <script src="<?php echo $video_edit_url; ?>/assets/subtitle/jquery-ui.min.js" type="text/javascript"></script>        
    <script src="<?php echo $video_edit_url; ?>/assets/subtitle/raphael.js" type="text/javascript"></script>
    <script src="<?php echo $video_edit_url; ?>/assets/subtitle/amalia.js.min.js" type="text/javascript"></script>
    <script src="<?php echo $video_edit_url; ?>/assets/subtitle/amalia.js-plugin-timeline.min.js" type="text/javascript"></script> -->
    <!-- end subtitle -->
	...
	<script type="text/javascript">
		...
		template.onload=function(){
			...
			$('#working_panel_top').attr('style',' height:'+height+'px;margin-top: 50px; margin-bottom: 42px; display: inline-block;');
